Sweep the top N (default 6) unresolved Sentry issues from org `arabgt`, project **`backend-prod`** (this repo's production project — the user may name another env like backend-qa), ordered by users affected, into Linear cards — ONLY in the "Sentry Bugs" project.
